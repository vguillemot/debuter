...
De plus la communauté des utilisateurs de R met à disposition 18653 (le 16/09/2022) packages qui permettent d'appliquer toutes les procédures statistiques imagineables, des plus classiques aux plus récentes.
...
![](img/S01rstudio/Rlogo.svg){width=25%}
...
Ouvrir un Terminal (Shell), taper R, puis "Entrée"

![](img/S01rstudio/Terminal.png){width=100%}
...
![](img/S01rstudio/RGUI.png){width=90%}

> $^\star$GUI = *Graphical User Interface*


## Rstudio, de chez "posit"

Le site : https://www.posit.co

![](img/S01rstudio/RStudio_Logo.png){width=25%}
...
![](img/S01rstudio/Rstudio.png){width=80%}
...
![](img/S01rstudio/Projet.gif){width=80% loop=10}
...
### Allez dans le menu "Help" puis sélectionnez "About Rstudio". Quelle est votre version de Rstudio ? Renseignez-la dans [le document partagé](https://docs.google.com/document/d/1C5hFVQe3BzlMRa62c-zPDmA9UvX5aKVgHRNieieex2c/edit?usp=sharing)
