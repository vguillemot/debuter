...
![](img/S00programme/vincent.jpeg){width=75%}
...
![](img/S00programme/amaury.jpg){width=75%}
...
![](img/S00programme/Kahoot_Logo.svg){width=100%}


## Au programme {.bigger}

 * Jour 1 : Bases de R
 * Jour 2 : Manipulation de données
 * Jour 3 : Réprésentations graphiques
 * Jour 4 : Analyses statistiques de base
 * Jour 5 : Analyse de vos propres données
...
![](img/S00programme/ciqual.jpg){width=100%}
...
![](img/S00programme/nutriwi.png){width=40%}
