...
![Keewee ou Koowoo ?](img/S07tests/keewee.png)
...
\[
  \displaystyle \frac{X^2_1}{X^2_2} \sim \mathcal F(d_1, d_2)
\]
...
## Comparer des proportions {.columns-2}
...
## Analyse en composantes principales {.columns-2}
