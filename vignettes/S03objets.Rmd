...
```{r head fruits, echo = TRUE, eval = FALSE}
head(fruits)
```

```{r head fruits evluated, echo = FALSE, eval = TRUE}
print.data.frame(head(fruits))
```

## Toute la table {.smaller}

```{r toute fruits, echo = TRUE, eval = FALSE}
fruits
```

```{r toute fruits evluated, echo = FALSE, eval = TRUE}
